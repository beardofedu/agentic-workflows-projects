...
4. If the scenario is **cancelled** and the issue is **directly blocked**, post a comment that explicitly says the issue is being closed due to a dependency-driven `not planned` outcome, then close the issue.
